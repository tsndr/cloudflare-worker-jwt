 ...
 */
export async function sign<Payload = {}>(payload: JwtPayload<Payload>, secret: string | JsonWebKey | CryptoKey, options: JwtSignOptions | JwtAlgorithm = 'HS256'): Promise<string> {
