...
export type JwtVerifyOptions = {
    ...
    */
    ...
    /**
     * If `true` not throw error if token generated by secret
     *
     * @default false
     */
...
export async function verify<Payload = {}, Header = {}>(token: string, secret: string | JsonWebKeyWithKid | CryptoKey | undefined, options: JwtVerifyOptions | JwtAlgorithm = "HS256"): Promise<JwtData<Payload, Header> | undefined> {
    ...
    try {
        ...
        if (decodedToken.payload) {
            ...
            if (!options.ignoreExpiration && decodedToken.payload.exp && decodedToken.payload.exp <= now && (now - decodedToken.payload.exp) > (options.clockTolerance ?? 0))
